...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin|PWR_ESP_EN_Pin|LCD_MOSI_Pin|LCD_SCK_Pin
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin */
  GPIO_InitStruct.Pin = SPI1_CS_Pin|PWR_ESP_EN_Pin|LCD_MOSI_Pin|LCD_SCK_Pin
                          |LCD_CS_Pin;
  ...
  GPIO_InitStruct.Pin = KEY2_R_Pin|KEY3_L_Pin|LCD_BUSY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
